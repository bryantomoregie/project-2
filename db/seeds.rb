...
review4 = Review.create(author:"Lisa", comments:"Great recipe!", ratings:  10, recipe_id: recipe2.id)
review5 = Review.create(author:"Raul", comments:"Great recipe!", ratings:  9, recipe_id: recipe3.id)
review6 = Review.create(author:"Mishi", comments:"Great recipe! Will try it out", ratings: 9, recipe_id: recipe3.id)
review7 = Review.create(author:"Anika", comments:"Great recipe!", ratings: 7, recipe_id: recipe4.id)
review8 = Review.create(author:"Lisa", comments:"Great recipe!", ratings: 8, recipe_id: recipe4.id)
review8 = Review.create(author:"Ahmed", comments:"Awesome!", ratings: 9, recipe_id: recipe5.id)
review9 = Review.create(author:"Tas", comments:"Great recipe!", ratings: 8, recipe_id: recipe5.id)
review10 = Review.create(author:"Lisa", comments:"Great recipe!", ratings: 7, recipe_id: recipe6.id)
review11 = Review.create(author:"Josh", comments:"Amazing!", ratings: 8, recipe_id: recipe6.id)
review12 = Review.create(author:"Lisa", comments:"Great recipe!", ratings: 9, recipe_id: recipe7.id)
review13 = Review.create(author:"Arturo", comments:"Delish!!", ratings: 7, recipe_id: recipe7.id)
review14 = Review.create(author:"Aiden", comments:"Making me Hungry!", ratings: 8, recipe_id: recipe8.id)
review15 = Review.create(author:"Faizah", comments:"Great recipe!", ratings: 9, recipe_id: recipe8.id)
review16 = Review.create(author:"Faizah", comments:"I love waffles. Thanks for sharing!", ratings: 7, recipe_id: recipe9.id)
review17 = Review.create(author:"Daphne", comments:"Great recipe!", ratings: 8, recipe_id: recipe10.id)
review18 = Review.create(author:"Dianna", comments:"This looks so good!", ratings: 7, recipe_id: recipe10.id)
review19 = Review.create(author:"Aiden", comments:"Great recipe!", ratings: 8, recipe_id: recipe11.id)
review20 = Review.create(author:"Ruth", comments:"Looks so good, gotta try it out!", ratings: 7, recipe_id: recipe12.id)
