...
recipe1 = Recipe.create(name: "Chicken Pizza", category: array[0], user_id: User.all.sample.id, recipe_url:  ,description: "")
recipe2 = Recipe.create(name: "Spaghetti", category: array[0], user_id: User.all.sample.id, recipe_url:  , description: "Magnifico! This Italian classic never goes out of style. Follow this simple recipe to impress your friend with an excellent version of a fan favorite")
recipe3 = Recipe.create(name: "Chicken Tacos", category: array[1], user_id: User.all.sample.id, recipe_url:  , description: "") 
recipe4 = Recipe.create(name: "Chicken Quesadilla", category: array[1], user_id: User.all.sample.id, recipe_url:  , description: "")
recipe5 = Recipe.create(name: "Croissants", category: array[2], user_id: User.all.sample.id, recipe_url:  , description: "")
recipe6 = Recipe.create(name: "Baguette", category: array[2], user_id: User.all.sample.id, recipe_url:  , description: "")
recipe7 = Recipe.create(name: "Pulled Pork", category: array[3], user_id: User.all.sample.id, recipe_url:  , description: "")
recipe8 = Recipe.create(name: "Chicken Fried Steak", category: array[3], user_id: User.all.sample.id, recipe_url:  , description: "") 
recipe9 = Recipe.create(name: "Buttermilk Waffles", category: array[4], user_id: User.all.sample.id, recipe_url:  , description: "")
recipe10 = Recipe.create(name: "Hamburgers", category: array[5], user_id: User.all.sample.id ,recipe_url:  , description: "")
recipe11 = Recipe.create(name: "Orange Chicken", category: array[5], user_id: User.all.sample.id, recipe_url:  , description: "")
recipe12 = Recipe.create(name: "Mapo Tofu", category: array[6], user_id: User.all.sample.id, recipe_url:  , description: "")
recipe13 = Recipe.create(name: "Katsu Curry", category: array[7], user_id: User.all.sample.id, recipe_url:  , description: "")
recipe14 = Recipe.create(name: "Teriyaki chicken", category: array[7], user_id: User.all.sample.id, recipe_url:  , description: "")
